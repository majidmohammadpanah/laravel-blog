<x-app-admin-layout>
    <x-slot name="header" >
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Manage of Categories
        </h2>
        <div class="mt-3">
            <a class="underline text-sm text-blue-600 hover:text-blue-700" href="{{ route('categories.create') }}">
                Add New Category
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-4 bg-white border-b border-gray-200">
                   @foreach($categories as $category)
                        <div class="flex items-center justify-between p-2 hover:bg-gray-50 transform transition duration-100">
                           ...
                           <div class="flex">
                               <a href="{{ route('categories.edit',$category->id) }}" class="inline-flex items-center transform transition duration-200 text-sm justify-center px-3 py-1 border border-transparent rounded-md text-indigo-800 bg-indigo-100 hover:bg-indigo-200">Edit</a>
